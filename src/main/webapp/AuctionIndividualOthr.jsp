...
<body>
	...
	%>
	<div style="width: 98%; border: 1px solid black; text-align: center; margin-left: 1%; margin-bottom: 1%;">
		<h3><%= aucName %></h3>
	</div>
	...
	<div id="popup">
		<div id="popup-container">
			<form>
				...
				<label for="autoBid">Enter Auto Bid Upper Limit (If needed):</label>
	...
	-->
	<form action="SubmitBid.jsp" method="post">
		<input type="submit" value="Bid Now" class="login_fields">
	</form>
